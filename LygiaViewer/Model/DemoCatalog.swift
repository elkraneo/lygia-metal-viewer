...
enum DemoCatalog {
    ...
    static let generative: [Demo] = [
        Demo(id: "fbmClouds", title: "Domain-warped fBm", module: .generative,
             ...
             params: [.slider("Scale", 0.5...10, 3), .slider("Speed", 0...2, 0.25), .slider("Warp", 0...4, 1.5)]),
        Demo(id: "noiseTypes", title: "Noise types", module: .generative,
             ...
             params: [.picker("Noise", ["snoise", "cnoise", "gnoise", "pnoise", "psrdnoise"]),
                      .slider("Scale", 1...20, 5), .slider("Speed", 0...2, 0.4)]),
        Demo(id: "voronoiCells", title: "Voronoi", module: .generative,
             ...
             params: [.slider("Scale", 1...20, 6), .slider("Speed", 0...3, 1), .toggle("Distance shading", true)]),
        Demo(id: "worleyCells", title: "Worley", module: .generative,
             ...
             params: [.slider("Scale", 1...20, 6), .slider("Speed", 0...2, 0.5), .toggle("Invert", false), .slider("Sharpness", 0.3...6, 2)]),
        ...
        Demo(id: "curlFlow", title: "Curl noise", module: .generative,
             ...
             params: [.slider("Scale", 0.5...8, 2), .slider("Speed", 0...1, 0.15), .slider("Streaks", 1...20, 8)]),
        Demo(id: "psrdnoiseFlow", title: "psrdnoise flow", module: .generative,
             ...
             params: [.slider("Scale", 1...16, 5), .slider("Rotation", 0...4, 1), .int("Period", 0...16, 0)]),
        Demo(id: "randomGrid", title: "Random", module: .generative,
             summary: "Hash functions random / random2 / random3 per pixel or per cell.",
             params: [.picker("Mode", ["White noise", "Per cell", "random3 per cell"], 2), .int("Cells", 2...64, 12), .slider("Reseed / s", 0...12, 1)]),
    ]
    ...
    static let sdf: [Demo] = [
        ...
        Demo(id: "kochSnowflake", title: "Koch snowflake", module: .sdf,
             ...
             params: [.int("Iterations", 0...7, 4), .slider("Rotation", -1...1, 0.1), .slider("Bands", 4...80, 40)]),
        ...
        Demo(id: "juliaSet", title: "Julia set", module: .sdf,
             ...
             params: [.slider("Zoom (r)", 0.5...3, 1.5), .slider("Speed", 0...1, 0.15), .slider("Orbit", 0.3...1, 0.7885)]),
        ...
        Demo(id: "spiralRays", title: "Spiral x rays", module: .sdf,
             ...
             params: [.slider("Turns", 0.5...6, 2), .int("Rays", 2...40, 12), .slider("Speed", 0...2, 0.3)]),
    ]
    ...
    static let space: [Demo] = [
        ...
        Demo(id: "hexTiles", title: "Hex tiles", module: .space,
             ...
             params: [.slider("Scale", 2...30, 10), .slider("Speed", 0...5, 2), .slider("Line width", 0.01...0.2, 0.06)]),
        Demo(id: "triTiles", title: "Triangle tiles", module: .space,
             summary: "triTile() splits the plane into equilateral triangles.",
             params: [.slider("Scale", 2...30, 8), .slider("Speed", 0...5, 1.5), .slider("Line width", 0.01...0.2, 0.05)]),
        Demo(id: "kaleidoscopeNoise", title: "Kaleidoscope", module: .space,
             ...
             params: [.int("Segments", 2...24, 8), .slider("Phase speed", -1...1, 0.2), .slider("Noise scale", 1...12, 4)]),
    ...
    static let color: [Demo] = [
        ...
        Demo(id: "spectralPalettes", title: "Spectral palettes", module: .color,
             ...
             params: [.slider("Scroll", -0.5...0.5, 0), .slider("Repeats", 1...4, 1)]),
        ...
        Demo(id: "hueShiftLayer", title: "Hue shift (layer)", module: .color, kind: .layer,
             ...
             params: [.slider("Hue (turns)", 0...1, 0), .slider("Spin", 0...1, 0.1), .slider("Desaturate", 0...1, 0)]),
    ]
    ...
    static let draw: [Demo] = [
        Demo(id: "drawPrimitives", title: "Primitives", module: .draw,
             ...
             params: [.slider("Size", 0.1...1.2, 0.6), .slider("Stroke width", 0.01...0.3, 0.08),
                      .picker("Mode", ["Fill", "Stroke", "Both"], 2), .slider("Spin", -2...2, 0.3)]),
    ]
    ...
    static let distort: [Demo] = [
        ...
        Demo(id: "motionStretch", title: "Stretch (motion blur)", module: .distort, kind: .layer,
             ...
             params: [.slider("Length", 0...0.3, 0.08), .slider("Angle (turns)", 0...1, 0), .slider("Rotate", 0...0.5, 0.1)]),
    ...
    static let ornament: [Demo] = [
        Demo(id: "hexRosette", title: "Hex rosettes", module: .ornament,
             ...
             params: [.slider("Scale", 1...12, 4), .slider("Rotation", -1...1, 0.2), .int("Petals", 3...12, 6), .slider("Line width", 0.01...0.1, 0.035)]),
        ...
        Demo(id: "mandala", title: "Mandala", module: .ornament,
             ...
             params: [.int("Segments", 3...24, 12), .slider("Rotation", -1...1, 0.1), .slider("Line width", 0.005...0.05, 0.015), .slider("Color speed", 0...0.5, 0.05)]),
        Demo(id: "truchetWeave", title: "Truchet weave", module: .ornament,
             ...
             params: [.slider("Scale", 2...30, 10), .slider("Reshuffle / s", 0...4, 0.5), .slider("Line width", 0.02...0.4, 0.16), .toggle("Checker tint", true)]),
        ...
        Demo(id: "vesicaLattice", title: "Vesica lattice", module: .ornament,
             ...
             params: [.slider("Scale", 1...16, 4), .slider("Vesica width", 0.1...1, 0.5), .slider("Line width", 0.01...0.12, 0.04), .slider("Shimmer", 0...4, 1)]),
    ]
}
